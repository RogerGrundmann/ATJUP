...
void JupiterUtils::fft_gaussian_filter(Array& in_data, int sigma){
    using namespace std;
...
void JupiterUtils::mirror_padding(double* data, size_t i_len, size_t p_len)
{
...
void JupiterUtils::fft_gaussian_filter(double* _data, double* kernel, size_t len){
...
void JupiterUtils::fft_gaussian_filter_3d(Array& data, int sigma)
{
    using namespace std;
