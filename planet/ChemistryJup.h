...
public:
    ...
    // ATJUP_CHEM_ENTHALPY — what the second term of thermalmassflux is. Default 0 = unchanged.
    //
    ...
    static int chem_enthalpy(){
        static const int v = [](){ const char* e = getenv("ATJUP_CHEM_ENTHALPY"); return e ? atoi(e) : 0; }();
        return v;
    }
